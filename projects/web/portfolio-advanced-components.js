...
(function () {
  ...
  window.addEventListener('load', function () {
    /* Hero canvas (#hero-webgl) is owned by portfolio-3d.js, a self-booting ES
       module. The old 2D particle field and cursor trail were removed here:
       the first is replaced by the 3D constellation, the second read as noise.
